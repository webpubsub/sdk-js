...
let sdkReposJSONPath = "http://api.github.com/repos/webpubsub/documentation-resources/contents/website-common/tools/build/sdk-repos.json?ref=" + sdkReposJSONBranch;
...
async function startExecution(sdkReposJSONPath){
    ...
    var yaml = fs.readFileSync(".webpubsub.yml", 'utf8');    
...
function parseReposAndFeatureMapping(body){
    if(body != null){
        ...
        if(locations!=null){
            ...
            var webpubsubYAMLSchemaURL = locations["webpubsubYAMLSchema"];
            return [sdkURLs, featureMappingURL, webpubsubYAMLSchemaURL];
        } else {
