...
var get_1 = __importDefault(require("./endpoints/objects/channel/get"));
var get_all_1 = __importDefault(require("./endpoints/objects/channel/get_all"));
var remove_1 = __importDefault(require("./endpoints/objects/channel/remove"));
var set_1 = __importDefault(require("./endpoints/objects/channel/set"));
var get_2 = __importDefault(require("./endpoints/objects/member/get"));
var set_2 = __importDefault(require("./endpoints/objects/member/set"));
var get_3 = __importDefault(require("./endpoints/objects/membership/get"));
var set_3 = __importDefault(require("./endpoints/objects/membership/set"));
var get_4 = __importDefault(require("./endpoints/objects/uuid/get"));
// Object API v2
var get_all_2 = __importDefault(require("./endpoints/objects/uuid/get_all"));
var remove_2 = __importDefault(require("./endpoints/objects/uuid/remove"));
var set_4 = __importDefault(require("./endpoints/objects/uuid/set"));
...
var default_1 = /** @class */ (function () {
    ...
    function default_1(setup) {
        ...
        // Objects API v2
        this.objects = {
            getAllUUIDMetadata: endpoint_1.default.bind(this, modules, get_all_2.default),
            getUUIDMetadata: endpoint_1.default.bind(this, modules, get_4.default),
            setUUIDMetadata: endpoint_1.default.bind(this, modules, set_4.default),
            removeUUIDMetadata: endpoint_1.default.bind(this, modules, remove_2.default),
            getAllChannelMetadata: endpoint_1.default.bind(this, modules, get_all_1.default),
            getChannelMetadata: endpoint_1.default.bind(this, modules, get_1.default),
            setChannelMetadata: endpoint_1.default.bind(this, modules, set_1.default),
            removeChannelMetadata: endpoint_1.default.bind(this, modules, remove_1.default),
            getChannelMembers: endpoint_1.default.bind(this, modules, get_2.default),
            setChannelMembers: function (parameters) {
                ...
                return endpoint_1.default.call.apply(endpoint_1.default, __spreadArray([_this,
                    modules,
                    set_2.default, __assign({ type: 'set' }, parameters)], __read(rest), false));
            },
            removeChannelMembers: function (parameters) {
                ...
                return endpoint_1.default.call.apply(endpoint_1.default, __spreadArray([_this,
                    modules,
                    set_2.default, __assign({ type: 'delete' }, parameters)], __read(rest), false));
            },
            getMemberships: endpoint_1.default.bind(this, modules, get_3.default),
