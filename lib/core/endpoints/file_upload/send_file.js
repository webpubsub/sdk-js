        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        if (!channel) {
                            throw new endpoint_1.WebPubSubError('Validation failed, check status for details', (0, endpoint_1.createValidationError)("channel can't be empty"));
                        }
                        if (!input) {
                            throw new endpoint_1.WebPubSubError('Validation failed, check status for details', (0, endpoint_1.createValidationError)("file can't be empty"));
                        }
                    ...
                    case 19:
                        ...
                        throw new endpoint_1.WebPubSubError(reason ? "Upload to bucket failed: ".concat(reason[1]) : 'Upload to bucket failed.', e_1);
                    case 20:
                        if (result.status !== 204) {
                            throw new endpoint_1.WebPubSubError('Upload to bucket was unsuccessful', result);
                        }
                    ...
                    case 25:
                        if (!wasSuccessful) {
                            throw new endpoint_1.WebPubSubError('Publish failed. You may want to execute that operation manually using webpubsub.publishFile', {
                                channel: channel,
                                id: id,
                                name: name,
                            });
