...
describe('grant token endpoint', () => {
  ...
  after(() => {
    ...
    webpubsub._config.getVersion = originalVersionFunction;
  });
  ...
  beforeEach(() => {
    ...
    if (originalVersionFunction === null) {
      originalVersionFunction = webpubsub._config.getVersion;
      webpubsub._config.getVersion = () => 'testVersion';
    }
  });
