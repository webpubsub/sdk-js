...
import { allChannels, asResponse, channel1 } from './fixtures';
...
describe('objects channel', () => {
  ...
  describe('getAllChannelMetadata', () => {
    it('should resolve to a list of channel metadata', async () => {
      ...
      const resultP = webpubsub.objects.getAllChannelMetadata({
        filter: 'test-filter',
        sort: {
          name: 'asc',
          description: null,
  ...
  describe('getChannelMetadata', () => {
    it('should resolve to channel metadata', async () => {
      ...
      const resultP = webpubsub.objects.getChannelMetadata({ channel: channelName });
    ...
    it('should reject if channel is empty', async () => {
      ...
      const resultP = webpubsub.objects.getChannelMetadata();
  ...
  describe('setChannelMetadata', () => {
    it('should resolve to updated channel metadata', async () => {
      ...
      const resultP = webpubsub.objects.setChannelMetadata({ channel: 'test-channel', data: channel1.data });
    ...
    it('should resolve to updated encoded channel metadata', async () => {
      ...
      const resultP = webpubsub.objects.setChannelMetadata({ channel: channelName, data: channel1.data });
    ...
    it('should reject if data is missing', async () => {
      // $FlowFixMe This is intentional to suppress Flow error
      const resultP = webpubsub.objects.setChannelMetadata();
  ...
  describe('removeChannelMetadata', () => {
    it('should resolve', async () => {
      ...
      const resultP = webpubsub.objects.removeChannelMetadata({ channel: channelName });
    ...
    it('should reject if uuid is missing', async () => {
      // $FlowFixMe This is intentional to suppress Flow error
      const resultP = webpubsub.objects.removeChannelMetadata();
