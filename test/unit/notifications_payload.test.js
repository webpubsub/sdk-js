...
import { APNSNotificationPayload, FCMNotificationPayload, MPNSNotificationPayload } from '../../src/core/components/push_payload';
...
describe('#notifications helper', () => {
  describe('payloads builder', () => {
    it('should prepare platform specific builders', () => {
      let expectedTitle = Webpubsub.generateUUID();
      let expectedBody = Webpubsub.generateUUID();

      let builder = Webpubsub.notificationPayload(expectedTitle, expectedBody);
    ...
    it('should pass subtitle to builders', () => {
      let expectedSubtitle = Webpubsub.generateUUID();

      let builder = Webpubsub.notificationPayload(Webpubsub.generateUUID(), Webpubsub.generateUUID());
    ...
    it('should pass sound to builders', () => {
      let expectedSound = Webpubsub.generateUUID();
    ...
    it('should provide payload for APNS2 and FCM', () => {
      let expectedTitle = Webpubsub.generateUUID();
      let expectedTopic = Webpubsub.generateUUID();
      let expectedBody = Webpubsub.generateUUID();
      let expectedPayload = {
        pn_apns: {
          aps: { alert: { title: expectedTitle, body: expectedBody } },
  ...
  describe('apns builder', () => {
    ...
    it('should set \'content-available\' when set silenced', () => {
      let builder = new APNSNotificationPayload(platformPayloadStorage, Webpubsub.generateUUID(), Webpubsub.generateUUID());
      builder.sound = Webpubsub.generateUUID();
      builder.badge = 20;
      builder.silent = true;
  ...
  describe('mpns builder', () => {
    ...
    it('should set \'back_title\'', () => {
      let expectedBackTitle = Webpubsub.generateUUID();
    ...
    it('should set \'back_content\' ', () => {
      let expectedBackContent = Webpubsub.generateUUID();
  ...
  describe('fcm builder', () => {
    ...
    it('should set \'icon\'', () => {
      let expectedIcon = Webpubsub.generateUUID();
    ...
    it('should set \'tag\'', () => {
      let expectedTag = Webpubsub.generateUUID();
